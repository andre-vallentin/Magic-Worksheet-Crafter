...
- `<!-- References -->` vor dem Quellen-Abschnitt
...
`<!-- Section -->` existiert **genau 3-mal** in der gesamten Datei — an diesen festen Positionen:

| # | Position | Was steht direkt davor | Was steht direkt danach |
|---|---|---|---|
| 1 | Nach dem Frontmatter | `---` (Ende YAML) | `<!-- InfoText -->` |
| 2 | Vor den Lösungen | letzte Aufgabe | `## Lösungen` |
| 3 | Vor den Quellen | letzter Lösungsblock | `<!-- References -->` |

Überall sonst: **kein** `<!-- Section -->`. Insbesondere NICHT zwischen InfoText und erster Aufgabe.

❌ Falsch — `<!-- Section -->` nach dem Informationstext:
```
<!-- InfoText -->
## Informationstext
...
...
✅ Richtig — InfoText geht direkt in Aufgabe 1 über:
```
<!-- InfoText -->
## Informationstext
...
...
- Erstelle Quellen nach dem Format in `references/references-example.md` — **KOPIERE die exakte Formatierung** (z.B. `[PDF-Name] S. # → Aufgabe(n): #`). Dokumentiere alle Quellen, die du für die Erstellung der Aufgaben und Informationen verwendet hast.
